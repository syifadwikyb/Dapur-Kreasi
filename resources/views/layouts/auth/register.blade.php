        ...
        <div class="w-1/2 p-8 flex flex-col justify-center">
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="fullName" name="name" placeholder="Adrian Septiyadi"
                ...
                <div class="mb-6 relative">
                    ...
                    <div class="flex relative items-center">
                        <input type="confirmPassword" id="confirmPassword" placeholder="********"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">            
                        <span class="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer" id="togglePassword">
                            <i class="fa fa-eye text-orange-500"></i>
                        </span>
            ...
            <p>Anda sudah punya akun? klik <span class="text-blue-700 underline"><a href="/login">disini</a></span></p>
        </div>
    </div>
</body>
